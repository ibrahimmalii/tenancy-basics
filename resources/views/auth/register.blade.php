    ...
    <form method="POST" action="/register">
        ...
        <div class="mt-4">
            ...
            <div class="flex items-center">
                <x-text-input id="domain" class="block mt-1 w-full" type="text" name="domain" :value="old('domain')" required autocomplete="username" />
                <label class="text-white ms-1">.{{ config('tenancy.central_domains')[0] }}</label>
            </div>
